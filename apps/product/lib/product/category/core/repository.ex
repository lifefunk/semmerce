defmodule Product.Category.Core.Repository do
  ...
  @callback update_name(category_aggregate :: CoreStructure.aggregate()) :: {:ok, CoreStructure.aggregate()} | CoreStructure.error()
  @callback update_desc(category_aggregate :: CoreStructure.aggregate()) :: {:ok, CoreStructure.aggregate()} | CoreStructure.error()
  @callback remove(category_aggregate :: CoreStructure.aggregate()) :: {:ok, CoreStructure.aggregate()} | CoreStructure.error()
end
